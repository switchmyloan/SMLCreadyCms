...
//             <tr key={row.id} className={`transition-colors duration-200 ${idx % 2 === 0 ? 'bg-white' : 'bg-gray-50'} hover:bg-purple-50 ${row.getIsSelected() ? 'bg-purple-100' : ''}`}>
...
//                     <div className="flex items-center gap-1">
//                         <button onClick={() => table.setPageIndex(0)} disabled={!table.getCanPreviousPage()} className="p-2 border rounded">
