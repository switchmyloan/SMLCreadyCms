...
const MetricsUpload = () => {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            console.log(result)
            setProcessedCount(result.recordsProcessed || 0);
            setStatus('success');
            ToastNotification.success(`Success! ${result.recordsProcessed} records processed.`);
            setFile(null);
            setTimeout(() => {
    ...
    return (
        <>
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                ...
                <div className={`border-2 border-dashed rounded-xl p-14 flex flex-col items-center justify-center transition-colors ${file ? 'border-blue-200 bg-blue-50' : 'border-gray-200'}`}>
                    {!file ? (
                        <>
