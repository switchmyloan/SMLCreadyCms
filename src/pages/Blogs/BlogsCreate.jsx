...
//           src={imageUrl}
//           alt="Blog preview"
//           className="w-full h-10 object-contain rounded mb-4"
//         />
...
//         <p className="text-sm"><strong>Tags:</strong> {selectedTags}</p>
//         <p className="text-sm"><strong>Status:</strong> {formData.status || 'Draft'}</p>
//         <p className="text-sm"><strong>Category:</strong> {formData.metadata?.category || 'No category'}</p>
